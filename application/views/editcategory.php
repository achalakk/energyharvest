...
<head>
    ...
    <!-- Title -->
    <title> Foodking || Edit Categories </title>
							...
							<!--<div class="col-lg-12">-->
                                ...
                                <div class="ibox bg-boxshadow mb-50">
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-12">     
											<?php foreach($eclist as $data) {?>                                       
                                                <!-- Form -->
                                                <form  class="form-horizontal col-md-8" id="validate-1"  method="post"  enctype="multipart/form-data" action="<?php echo base_url(); ?>updatecate/<?php echo $data->id; ?>">
                                                  
												  
												  <div class="form-group">
													<label>Name</label> 
									 <input type="text" placeholder="Enter Category Name" name="title" id="title" class="form-control"  value="<?php echo $data->category_name ?>" onchange="getValue1(this.value);" required>
										            ...
										            <option value="">Select.....</option>
									                 <?php 
									                   foreach($tlist as $data1){
									                  ?>
																					 
									           <option value="<?php echo $data1->id; ?>" <?php if($data->cate_type==$data1->id) {?> selected="selected" <?php } ?>><?php echo $data1->type_name;?></option>												  
									           <?php } ?>
									               </select>									 
									           </div> 
