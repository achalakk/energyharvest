...
<head>
    ...
    <!-- Title -->
    <title> Foodking || Edit CategoryType </title>
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> <a href="<?php echo base_url(); ?>typelist">CategoryType</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-12">                                             
                                                <!-- Form -->
												<?php 
												foreach($etlist as $ldata){
												?>
                                                <form  class="form-horizontal col-md-8" id="validate-1"  method="post"  enctype="multipart/form-data" action="<?php echo base_url(); ?>updatetype/<?php echo $ldata->id;?>">
                                                  
												  
												  <div class="form-group">
													<label>Name</label> 
									 <input type="text" placeholder="Enter Location Name" name="name" id="title" class="form-control"  value="<?php echo $ldata->type_name;?>" onchange="getValue1(this.value,'<?php echo $ldata->type_name; ?>');" required>
