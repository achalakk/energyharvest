...
<head>
    ...
    <!-- Title -->
    <title> Foodking || Add items </title>
                                ...
                                <div class="ibox bg-boxshadow mb-50">
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-12">                                             
                                                <!-- Form -->
                                                <form  class="form-horizontal col-md-8" id="validate-1"  method="post"  enctype="multipart/form-data" action="<?php echo base_url(); ?>insertitem">
									 ...
									 <input type="text" placeholder="Enter minititle" name="minititle" id="minititle" class="form-control"  value="" >
													</div>
									 ...
									 <input type="text" placeholder="Enter item Name" name="item" id="item" class="form-control"  value="" onchange="getValue1(this.value);" required>
													</div><span id="errmsg1" class="text-danger"></span>
													
													<div class="form-group">
													<label> Description</label> 
													<textarea rows="4" name="description" cols="10" class="form-control" ></textarea>
													</div>
												...
												<input type="file" name="file1[]" multiple="multiple" id="file1" class="form-control"   onchange="fileValidation()"/><span id="errmsg" class="text-danger"></span><br/>
													...
													<div class="form-group">
													<label>Price</label> 
									 <input type="text" placeholder="Enter item price" name="price" id="price" class="form-control"  value=""  required>
													</div>
													
													<div class="form-group">
													<label>Discount(%)</label> 
									 <input type="text" placeholder="Enter discount percentage" name="discount" id="discount" class="form-control"  value=""  onchange="getValue2(this.value);">
													</div>
