...
<head>
    ...
    <!-- Title -->
    <title> Foodking || Categories </title>
				 ...
				 <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="ibox bg-boxshadow">
								 ...
								 <a href="<?php echo base_url(); ?>addcate"><button class="btn btn-primary mt-2 float-right"> <i class="fa fa-plus"> </i> Add Category</button></a> 							
                           ...
                           <th scope="col" class="noExport">Action</th>
							...
							?>
                                            ...
                                            <tr>
												...
												?>
												<li><img src="<?php echo base_url(); ?>/<?php echo $img; ?>" height="100px" width="100px"></li>
												<?php } ?>
												</ul>
												</td>
																		
									            <td>  
												<strong><span style="color:green"><a href="<?php echo base_url(); ?>editcategory/<?php echo $data->id;?>" title="Edit" class="btn btn-success mr-1"> 
                                                <i class="fa fa-edit"> </i> Edit</a></span></strong>&nbsp;&nbsp;
                                                 <span style="color:red"><strong><a href="<?php echo base_url(); ?>deletecategory/<?php echo $data->id;?>" onClick="return confirm('Are you sure you want to delete ?')" title="Delete" class="btn btn-danger "> <i class="fa fa-trash-alt"> </i>  Delete</a></strong></span></td>
										      </td>
                                            </tr>
							<?php $sno++; } }?>
                                             </tbody>
