...
<head>
    ...
    <!-- Title -->
    <title> Foodking || Category Type </title>
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> <a href="<?php echo base_url(); ?>typelist">Category Type</a></li>
				 ...
				 <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="ibox bg-boxshadow">
								 ...
								 <a href="<?php echo base_url(); ?>addtype"><button class="btn btn-primary mt-2 float-right"> <i class="fa fa-plus"> </i> Add Category Type</button></a> 							
                           ...
                           <th scope="col" class="noExport">Action</th>
							...
							?>
                                            ...
                                            <tr>
									            ...
									            <td>  
												<strong><span style="color:green"><a href="<?php echo base_url(); ?>edittype/<?php echo $data->id;?>" title="Edit" class="btn btn-success mr-1"> 
                                                <i class="fa fa-edit"> </i> Edit</a></span></strong>&nbsp;&nbsp;
                                                 <span style="color:red"><strong><a href="<?php echo base_url(); ?>deletetype/<?php echo $data->id;?>" onClick="return confirm('Are you sure you want to delete ?')" title="Delete" class="btn btn-danger "> <i class="fa fa-trash-alt"> </i>  Delete</a></strong></span></td>
										      </td>
                                            </tr>
							<?php $sno++; } }?>
                                             </tbody>
