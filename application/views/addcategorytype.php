...
<head>
    ...
    <!-- Title -->
    <title> Foodking || Add Category Type </title>
                                ...
                                <div class="ibox bg-boxshadow mb-50">
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-12">                                             
                                                <!-- Form -->
                                                <form  class="form-horizontal col-md-8" id="validate-1"  method="post"  enctype="multipart/form-data" action="<?php echo base_url(); ?>inserttype">
                                                  
												  
												  <div class="form-group">
													<label>Name</label> 
									 <input type="text" placeholder="Enter Category Type" name="name" id="title" class="form-control"  value=""  onchange="getValue1(this.value);" required>
