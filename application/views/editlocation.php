                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> <a href="<?php echo base_url(); ?>locList">Locations</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-12">                                             
                                                <!-- Form -->
												<?php 
												foreach($llist as $ldata){
												?>
                                                <form  class="form-horizontal col-md-8" id="validate-1"  method="post"  enctype="multipart/form-data" action="<?php echo base_url(); ?>updateLoc/<?php echo $ldata->id;?>">
                                                  
												  
												  <div class="form-group">
													<label>Name</label> 
									 <input type="text" placeholder="Enter Location Name" name="title" id="title" class="form-control"  value="<?php echo $ldata->name;?>" onchange="getValue1(this.value,'<?php echo $ldata->name; ?>');" required>
...
function getValue1(val1,val2){
	   ...
	   var val3 = val1.toLowerCase();
		var val4 = val2.toLowerCase();
       if(val3!=val4){		
       $.post('<?php echo base_url(); ?>Login/loc_taken',
      { 'loc':val1 },
 
      function(result) {
       
        if (result) {
         $("#errmsg1").html("This Location already exist").fadeIn('slow').delay(5000).hide(1);
				$("#title").val("");
				$("#title").focus();
        }
		else
